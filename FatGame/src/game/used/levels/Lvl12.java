 ...
 */
public class Lvl12 extends GameLevels implements Serializable {
    public Lvl12(Game game) {
        super(game);
        //sound
        try {
            gameMusic = new SoundClip("data/sound/pluckedchicken.wav");   // Open an audio input stream
    ...
    public void populate(Game game){
        super.populate(game);
        comic12 = new ComicStrip12(this, game);
