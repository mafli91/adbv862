 ...
 * @see GameLevels
 */
public class Lvl7 extends GameLevels implements Serializable {
    ...
    public Lvl7(Game game) {
        super(game);

        //sound
        try {
            gameMusic = new SoundClip("data/sound/Weird Al Yankovic- Fat.mp3");   // Open an audio input stream
        ...
        Shape b2 = new BoxShape(13, 0.3f);
        StaticBody b22 = new StaticBody(this, b2);
        b22.setPosition(new Vec2(-104, 19));
        ...
        butt1.setPosition(new Vec2(80.87748f, 88.708954f));
        ...
        door11.setPosition(new Vec2(-58, 117));
        door11.addCollisionListener(new DoorListener(game, this, butt1));

        Shape door2 = new BoxShape(15, 0.4f);
        StaticBody door21 = new StaticBody(this, door1);
        door21.setFillColor(Color.BLUE);
        door21.setPosition(new Vec2(104, 132));
        door21.setAngleDegrees(90);
        door21.addCollisionListener(new DoorNextLevel(game, this, butt1));
    ...
    public void populate(Game game){
        ...
        // Hero methods
        getFatLady().setPosition(new Vec2(5, -91));
    ...
    public JLabel playerTips(){
        ...
        label.setText("<html>" +
                "<body width='170'>\n" +
                "<p>\n" +
                "Open the button, go to the surface and go into the boss door. \n" +
